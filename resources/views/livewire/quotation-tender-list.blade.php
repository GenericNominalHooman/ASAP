                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        KERJA-KERJA PENGUBAHSUAIAN PEJABAT BAHAGIAN KERAJAAN TEMPATAN DI BANGUNAN PERAK
                                        DARUL RIDZUAN </td>
                                    <td class="px-6 py-4">
                                        B 28
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="#"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">NO</a>
                                    </td>
                                    <td class="px-6 py-4">
                                        -
                                    </td>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        PENGGANTIAN BUMBUNG DI PEJABAT DOMESTIK SERTA KERJA-KERJA BERKAITAN DI INSTITUT
                                        TANAH & UKUR NEGARA (INSTUN), PERAK DARUL RIDZUAN
                                    </td>
                                    <td class="px-6 py-4">
                                        B 24
                                    </td>
